...
import { getUserProfile, followUsers, unFollowUsers } from "../../app/actions/post";
...
const Profile = () => {
  ...
  const userProfileInfo = useSelector(state => state.postAction.userProfileInfo)
  ...
  return (
    <>
      <div style={{ width: "50%", margin: "0px auto" }}>
        ...
        >
          ...
          >
            ...
            <div className="pr__pic_ri">
              ...
              >
                <p className="">
                  <span className="comm__text_bold">{userProfileInfo.posts.length}</span>{" "}
                  posts
                </p>
                <p className="">
        ...
        <div>
          {tabs === "posts" && <OtherProPost myPosts={userProfileInfo.posts} />}
          {tabs === "saved" && <MySaved />}
          {tabs === "taged" && <MyTaged />}
        </div>
      </div>
